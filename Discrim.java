...
public class Discrim {
    public static void main(String[] args) {
        ...
        public static String discriminant (double a,double b,double c){
            ...
            {
                return "Дискриминант " + Disc1 ;

            }
/**Как значение которые мы вводим с клавиатуры A,B,C присвоить значениям в функции
 * discriminant a,b,c? А то формула не учавствует вообще...
 */
        }
